			...
			<table class="table table-striped"
				...
				<tbody>
					<tr>
						...
						<td colspan="2"><%=bbs.getBbsTitle().replaceAll(" ", "&nbsp;").replaceAll("<", "&It;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></td>
					</tr>
					<tr>
						<td >작성자</td>
					...
					<tr>
						<td >내용</td>
						<td colspan="2" style="min-height: 200px;  text-align:center;"><%=bbs.getBbsContent().replaceAll(" ", "&nbsp;").replaceAll("<", "&It;").replaceAll(">", "&gt;").replaceAll("\n", "<br>")%></td>
					</tr>
				</tbody>
			</table>
